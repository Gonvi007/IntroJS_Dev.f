const ListaProductosTienda = [
  ...
  const comprar = (nombre, precio) => alert(`Hola, gracias por comprar el producto ${nombre} por un valor de $ ${precio}`);

  const crearHtml = () => {
    // console.log("Creando Htmls...")
    ...
    productos.forEach((producto) => {
      ...
      <p>Descripsion: <span>${producto.descripcion}</span></p>
